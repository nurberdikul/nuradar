...
@override
String toString() {
  return 'TaskModel(id: $id, title: $title, description: $description, dueDate: $dueDate, priority: $priority, isCompleted: $isCompleted, imageUrls: $imageUrls, category: $category, latitude: $latitude, longitude: $longitude, userId: $userId)';
}
...
class _TaskModel extends TaskModel {
  const _TaskModel({required this.id, required this.title, required this.description, required this.dueDate, this.priority = TaskPriority.medium, this.isCompleted = false, final  List<String> imageUrls = const [], this.category, this.latitude, this.longitude, this.userId}): _imageUrls = imageUrls,super._();
