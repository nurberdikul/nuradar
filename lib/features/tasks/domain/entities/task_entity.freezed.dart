...
@override
String toString() {
  return 'TaskEntity(id: $id, title: $title, description: $description, dueDate: $dueDate, isCompleted: $isCompleted, imageUrls: $imageUrls, category: $category, latitude: $latitude, longitude: $longitude)';
}
...
class _TaskEntity extends TaskEntity {
  const _TaskEntity({required this.id, required this.title, required this.description, required this.dueDate, this.isCompleted = false, final  List<String> imageUrls = const [], this.category, this.latitude, this.longitude}): _imageUrls = imageUrls,super._();
